...
export default function Home() {
  return (
    <>
      ...
      {/* Footer with trust/legal links (required for AdSense) */}
      <footer className="border-t bg-white dark:bg-zinc-950">
        <div className="max-w-4xl mx-auto px-4 py-6 flex flex-wrap gap-x-4 gap-y-2 text-xs text-muted-foreground">
